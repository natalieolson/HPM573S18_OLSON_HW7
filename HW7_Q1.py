...
class Cohort:
    ...
    def n_5year_survivors(self, pop_size):
        self.n_5year_survivors = 0
        for obs in self._patients:
                if self._survivalTimes >5:
                    self.n_5year_survivors += 1

    def survivor_proportion(self):
        return sum(self.n_5year_survivors)/len(self._survivalTimes)
...
class CohortOutcomes:
    ...
    def get_proportion_survivors(self):
        return self._simulatedCohort.survivor_proportion()
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._cohortsurvivorproportion = []
